...
Em primeiro lugar, são criados os quatro utilizadores, cada um com uma palavra-passe e acesso apenas a partir do servidor local. De seguida, são criados os papéis correspondentes: socio, professor, funcionario e administrador.
